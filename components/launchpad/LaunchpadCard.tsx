...
export const LaunchpadCard = ({ ...props }: LaunchpadI) => {
  return (
    <div className="border-[1px] border-primary-100/50 relative">
      <div className="p-4 h-[8rem] from-primary-80/5 to-primary-80/20 bg-gradient-to-r relative overflow-hidden flex items-center justify-center flex-col">
        ...
        <p className="relative text-custom-white/70 text-sm text-center backdrop-blur-[22px] p-1 rounded-sm">
          DeFi Liquidity Protocol on Bitcoin
        </p>
      </div>
